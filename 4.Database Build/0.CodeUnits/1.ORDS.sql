...
WHERE
    ...
    ords.define_template(p_module_name => 'xxgstt_arss_invoice_request', p_pattern => 'get_invoice_line_dist/:invoice_id');
    ords.define_handler(p_module_name => 'xxgstt_arss_invoice_request', p_pattern => 'get_invoice_line_dist/:invoice_id',
                       p_method => 'GET',
                       p_source_type => ords.source_type_collection_feed,
                       p_source => 'SELECT
    l.id,
    ...
    unitprice,
    t.name taxcode,
    allocationamount distributionamount,
    organization,
    costcentre,
    subjective,
    wga,
    ...
    spare2,
    l.createdby,
    to_char(l.creationdate,''DD.MM.YYYY'') creationdate,
    l.lastupdatedby,
    to_char(l.lastupdatedate,''DD.MM.YYYY'') lastupdatedate
FROM
    vb_vb_istvpkfgk4j.invoiceline l,
    vb_vb_istvpkfgk4j.invoicedistribution d,
	vb_vb_istvpkfgk4j.taxcode t
...
https://foizja9l9puedqg-gsttadwdev.adb.uk-london-1.oraclecloudapps.com/ords/arss/xxgstt_arss_invoice_request/get_invoice_line_dist/{inv_id}
